...
def main():
    ...
    d_tree_classifier = d_tree.fit(x_train, y)                  # keep doing the recursion, calculate the gini impurity
    print('Training Acc: ', d_tree_classifier.score(x_train, y))   # For classification
    ###################
